 ...
 * @author HP
 */
public class TambahAkunFrame extends javax.swing.JDialog {

    /**
     * Creates new form TambahAkunFr
     */
    public TambahAkunFrame(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        TambahBTN.setBackground(new java.awt.Color(0, 102, 204));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TambahAkunFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TambahAkunFrame dialog = new TambahAkunFrame(new javax.swing.JFrame(), true);
